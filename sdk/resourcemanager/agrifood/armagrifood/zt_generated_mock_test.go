...
func (testsuite *MockTestSuite) TestExtensions_Create() {
	...
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Create.json
	...
	_, err = client.Create(ctx,
		...
		"examples-rg",
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Create.json")
}

func (testsuite *MockTestSuite) TestExtensions_Get() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Get.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	res, err := client.Get(ctx,
		...
		"examples-rg",
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Get.json")
	// Response check
	...
	if !reflect.DeepEqual(exampleRes, res.Extension) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestExtensions_Update() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Update.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	res, err := client.Update(ctx,
		...
		"examples-rg",
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Update.json")
	// Response check
	exampleRes := armagrifood.Extension{
		Name: to.Ptr("provider.extension"),
		Type: to.Ptr("Microsoft.AgFoodPlatform/farmBeats/extensions"),
	...
	if !reflect.DeepEqual(exampleRes, res.Extension) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.Extension)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Update.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestExtensions_Delete() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Delete.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	_, err = client.Delete(ctx,
		...
		"examples-rg",
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_Delete.json")
}

func (testsuite *MockTestSuite) TestExtensions_ListByFarmBeats() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_ListByFarmBeats.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		...
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_ListByFarmBeats.json")
		// Response check
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.ExtensionListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Extensions_ListByFarmBeats.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsExtensions_List() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsExtensions_List.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsExtensions_List.json")
		// Response check
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsExtensionListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsExtensions_List.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsExtensions_Get() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsExtensions_Get.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	res, err := client.Get(ctx,
		"DTN.ContentServices",
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsExtensions_Get.json")
	// Response check
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeatsExtension) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsExtensions_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_Get() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_Get.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	res, err := client.Get(ctx,
		...
		"examples-farmBeatsResourceName",
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_Get.json")
	// Response check
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_CreateOrUpdate() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_CreateOrUpdate.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	res, err := client.CreateOrUpdate(ctx,
		...
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_CreateOrUpdate.json")
	// Response check
	exampleRes := armagrifood.FarmBeats{
		Name:     to.Ptr("examples-farmbeatsResourceName"),
		Type:     to.Ptr("Microsoft.AgFoodPlatform/farmBeats"),
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.FarmBeats)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_CreateOrUpdate.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_Update() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_Update.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	res, err := client.Update(ctx,
		...
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_Update.json")
	// Response check
	exampleRes := armagrifood.FarmBeats{
		Name:     to.Ptr("examples-farmBeatsResourceName"),
		Type:     to.Ptr("Microsoft.AgFoodPlatform/farmBeats"),
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.FarmBeats)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_Update.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_Delete() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_Delete.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	_, err = client.Delete(ctx,
		...
		"examples-farmBeatsResourceName",
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_Delete.json")
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_ListBySubscription() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_ListBySubscription.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_ListBySubscription.json")
		// Response check
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_ListBySubscription.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsModels_ListByResourceGroup() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_ListByResourceGroup.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_ListByResourceGroup.json")
		// Response check
		pagerExampleRes := armagrifood.FarmBeatsListResponse{
			Value: []*armagrifood.FarmBeats{
				{
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsListResponse) {
			exampleResJson, _ := json.Marshal(pagerExampleRes)
			mockResJson, _ := json.Marshal(nextResult.FarmBeatsListResponse)
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/FarmBeatsModels_ListByResourceGroup.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestLocations_CheckNameAvailability() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Locations_CheckNameAvailability_AlreadyExists.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	res, err := client.CheckNameAvailability(ctx,
		...
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Locations_CheckNameAvailability_AlreadyExists.json")
	// Response check
	...
	if !reflect.DeepEqual(exampleRes, res.CheckNameAvailabilityResponse) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Locations_CheckNameAvailability_AlreadyExists.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}

	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Locations_CheckNameAvailability_Available.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	res, err = client.CheckNameAvailability(ctx,
		...
		nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Locations_CheckNameAvailability_Available.json")
	// Response check
	exampleRes = armagrifood.CheckNameAvailabilityResponse{
	...
	if !reflect.DeepEqual(exampleRes, res.CheckNameAvailabilityResponse) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.CheckNameAvailabilityResponse)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Locations_CheckNameAvailability_Available.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestOperations_List() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Operations_List.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Operations_List.json")
		// Response check
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.OperationListResult) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-02-08/examples/Operations_List.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
